define([
    ...
    var app = angular.module('mch', ['ui.bootstrap', 'ui.select','ui.sortable', 'states', 'ngProgress', 'xeditable', 'ngCkeditor', 'ngDragDrop', 'ngResource', 'ngClipboard', 'flash', 'ngAnimate', 'ngPopover', 'ngDateRange', 'mwl.confirm', 'controllers', 'directives', 'services','templates']);
