 ...
 */
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
            ...
            '<input class="form-control input-sm" type="text" name="daterangepicker_start" value="" />' +
            '</div>' +
            '<div class="daterangepicker_end_input">' +
            '<input class="form-control input-sm" type="text" name="daterangepicker_end" value="" />' +
            '</div>' +
            '</div>' +
            '<label>快捷日期：</label>' +
            '<ul class="quick-list">' +
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.ranges === 'object') {
                ...
                this.container.find('.quick-list li').remove();
                this.container.find('.quick-list').html(list);
            }
